...
public:
    ...
    VulkanExample() : VulkanBase() {
        title = "Vulkan Example - Basic indexed triangle";
        // Setup a default look-at camera
        perspective = glm::perspective(glm::radians(60.0f), (float)width / (float)height, 1.0f, 256.0f);
    ...
    // Note: Override of virtual function in the base class and called from within VulkanBase::prepare
    ...
    void preparePipelines()
    {
        ...
        shaderStages[0].module = loadSPIRVShader(getShadersPath() + "triangle.vert.spv");
        ...
        // Load binary SPIR-V shader
        shaderStages[1].module = loadSPIRVShader(getShadersPath() + "triangle.frag.spv");
        // Main entry point for the shader
    ...
    void updateUniformBuffers()
    {
        ...
        uboVS.projectionMatrix = perspective;
